...
### Board analysis: 
Edit board states freely or generate random puzzles with configurable pieces. Build using block tools, temp blocks (which disappear on evaluation), and eraser.
...
### Visualization: 
Toggleable graphs for playout evaluation and piece-by-piece comparison between player and engine choices.
